...
Такой пакет особенно полезен в долгоживущих сервисах (HTTP‑серверы, фоновые задачи, микросервисы), где важно гарантировать освобождение
всех ресурсов при остановке приложения — в том числе через сигналы ОС (SIGTERM и др.).
